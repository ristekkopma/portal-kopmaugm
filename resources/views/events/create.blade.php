...
<head>
    ...
    <title>Tambah Event | Kopma UGM</title>
            ...
            >
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="title"
                        value="{{ old('title') }}"
                        placeholder="Contoh: Rapat Persiapan RAT Kopma"
                        required
                    >
                ...
                <div class="form-group">
                    ...
                    <textarea
                        id="description"
                        name="description"
                        placeholder="Tuliskan informasi penting mengenai event..."
                ...
                <div class="form-group">
                    ...
                    <div class="help-text">
                        Kolom ini opsional. Kosongkan apabila event tidak memiliki link tambahan.
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="help-text">
                        Format gambar: JPG, JPEG, PNG, atau WEBP. Ukuran maksimal 2 MB.
                    </div>
